...
- [ ] Try, multiple times if necessary, to create those tokens from the lines
read with `readline()`.
	- [ ] What are those tokens?
	- [ ] Why do we need those tokens, why are they important for this project?
	- [ ] 
...
### `cmdenv builder` module (shitty name)

- [ ] ???

### `cmd executor` module (shitty name)
